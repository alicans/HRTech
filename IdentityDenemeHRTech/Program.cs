...
using (var scope = app.Services.CreateScope())
{
    ...
    if (!await userManager.Users.AnyAsync(x => x.UserName == "admin@example.com"))
    {
        var adminUser = new ApplicationUser()
        {
            ...
            Soyad = "User",
            TcNo = "12345678901",
            IseGirisTarihi = DateTime.Now.AddYears(-1), // 1 yýl önce
            IstenCikisTarihi = null, // Henüz iþten çýkmadý
            DepartmanId=1,
            
            Aktiflik = true, // Hesap aktif
            MeslekId = 3, // Örnek bir meslek ID'si
            AdresId = 1, // Örnek bir adres ID'si
            Telefon = "5555555555",
            Maas = 5000.00m,
            Cinsiyet = Cinsiyet.Erkek, // Örnek bir cinsiyet
            Harcamalar = new List<Harcama>(), // Boþ bir harcama listesi
            Izinler = new List<Izin>(), // Boþ bir izin listesi
            Avanslar = new List<Avans>() // Boþ bir avans listesi,
